...
2. Download [super_empty.img](https://updater.oddsolutions.us/devices/{{ custom_recovery_codename }}/builds) since your device uses retrofitted dynamic partitions.
{%- endif %}
