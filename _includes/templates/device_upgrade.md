...
7. Update to the latest [Lineage Recovery](https://updater.oddsolutions.us/devices/{{ device.codename }}) image. Simply download the latest recovery file, named `{{ device.recovery_partition_name }}.img`.
