...
## What not to report
  - Bugs in unofficial builds or anything not downloaded from [our official portal](https://updater.oddsolutions.us/) - this includes other ROMs "based on" LineageOS as well!
  - Missing builds
